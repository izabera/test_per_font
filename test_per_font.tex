...
\centerline{\scalefont{8}\mycolor{}#4\resetcolor{}}\par\vspace*{2cm}%
...
\testfont{\scala}{FF Scala}{YogurteEia}
...
\testfont[Da risolvere: non ingrandisce il carattere nel titolo]{\frakfamily}{Fraktur}{Ricettario}
